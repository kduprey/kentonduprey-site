...
const ProjectCard = ({ image, title, blurb, link }) => {
	...
	// return (
	// 	<div className="w-[90%] md:auto rounded-lg flex flex-col items-center justify-center">
	// 		<div className="relative h-[300px] w-full">
	// 			<Image
	// 				src={image}
	// 				layout="fill"
	// 				className="  transition-objectFit object-cover ease-in hover:object-contain"
	// 			/>
	// 		</div>
	// 		<h3 className="font-semibold text-center">{title}</h3>
	// 		<p className="leading-none font-light text-center">{blurb}</p>
	// 		<Link href={link} passHref>
	// 			<Button
	// 				text="Explore"
	// 				className="mx-auto bg-gray-500 text-gray-50 hover:bg-gray-600 hover:text-white transition ease-in"
	// 			/>
	// 		</Link>
	// 	</div>
	// );
